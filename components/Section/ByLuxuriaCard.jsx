...
export const ByLuxuriaCard = ({locale}) => {
    ...
    return (
        <Flex
            ...
            gap={8}
        >
            <Image display={{md:"none"}} width={"200px"} height={"38px"} src="/images/logolux.webp" alt="" />
            <Image display={{base:"none", md:"initial"}} width={"281px"} height={"53px"} src="/images/logolux.webp" alt="" />
            {/* <MotionHeading
